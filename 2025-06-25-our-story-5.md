---
layout: default
title: "Step 5: AIの不可解な言葉と、スーパー建築士『Jekyll』の登場 - アラフィフ親父でも出来た。"
category: our_story
class: blog-post
---
...
<div class="container blog-post" style="max-width: 850px;">
    ...
    <div class="content">
        <div class="step-box">
            ...
            <p>
                4日間の激闘の末、サイトを整理しやすくする為、『AIの指示通り』の部品はすべて揃ったはず。
            ...
            <p>
                さっきまでの画面に、映ってたのは、どこいった？心が折れそうになりながら、いつものように、「AIに丸投げ」。
            ...
            <p>
                今までのHTMLの知識が、ある意味で通用しない、まったく新しいルール。
            ...
            <h3>そして、本当の「自動化」へ</h3>
            <p>
                Pythonでやってたのは、<strong>「コンテンツを作る自動化」</strong>だった。<br>
            ...
            <p>
                5日目、ついに本当のプロの領域に、ほんの少しだけ、足を踏み入れたらしい。この戦い、ほんとに終わりそうにない。
